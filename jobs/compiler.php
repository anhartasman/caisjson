...
function tescompile($compileto,$thejson){
}
function compile($compileto,$thejson){
$paket=array();
        $bahan_respon = "";
        $web_config=null;
        $generated_code="";
  ...
  for($j=0; $j<count($thejson->project_config); $j++){
    ...
    if($theconfig->config_type==$compileto && ($theconfig->config_type=="web" || $theconfig->config_type=="weblaravel")){
    ...
    $manifest = $thejson;
    //echo $isijson;
    //echo "manifest".$manifest['project_name'];
  //echo $isijson;
    ...
    //write_the_files($paket,$filedirection);
...
function file_teller($compileto,$thejson){
$paket=array();
        $bahan_respon = "";
        $web_config=null;
        $generated_code="";
