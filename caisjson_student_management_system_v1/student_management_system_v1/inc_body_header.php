...
<li class="<?php if($modul_id=="tabel_siswa"){ print("active"); } ?> treeview">
  <a href="#">
    <i class="fa fa-dashboard"></i> <span>Tabel Siswa</span>
...
<li class="<?php if($modul_id_page_id=="tabel_siswa_daftar_siswa"){ print("active"); } ?>"><a href="http://localhost/sistemsekolah/admin/tabel_siswa/daftar_siswa"><i class="fa fa-circle-o"></i> Daftar Siswa</a></li>

  </ul>
</li>

<li class="<?php if($modul_id=="tabel_hotel"){ print("active"); } ?> treeview">
  <a href="#">
...
<li class="<?php if($modul_id_page_id=="tabel_hotel_daftar_hotel"){ print("active"); } ?>"><a href="http://localhost/sistemsekolah/admin/tabel_hotel/daftar_hotel"><i class="fa fa-circle-o"></i> Daftar Hotel</a></li>
