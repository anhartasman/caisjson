<?php
include "../mvc_model/model_tabel_tb_akun.php";
include "../mvc_model/model_tabel_tb_authlevel.php";

class model_controller_account {
...
$obj_table_tb_authlevel->db=$this->db;
