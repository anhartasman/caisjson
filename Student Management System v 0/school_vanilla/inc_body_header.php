...
<li class="<?php if($modul_id_page_id=="tabel_siswa_daftar_siswa"){ print("active"); } ?>"><a href="http://localhost/school_vanilla/admin/tabel_siswa/daftar_siswa"><i class="fa fa-circle-o"></i> Daftar Siswa</a></li>

  </ul>
</li>

        <li><a href="<?=$base_url?>/admin/system_information/documentation"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
