  ...
  <div class="row">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Siswa <th><a href="http://localhost/school_laravel/admin/tabel_siswa/add_siswa">Tambah</a></th>
</h3>
            </div>
...
var url="http://localhost/school_laravel/API";
...
$('#pilih_kelas').html(data_contentset_dropdown_pilihan_kelas);
}
...
var objextractJSONTingkat=JSON.parse(dataextractJSONTingkat);
var content_of_extractJSONTingkat=objextractJSONTingkat[targetextractJSONTingkat];
...
if(data_contentset_dropdown_tingkat.length>0){
$('#tingkat_kelas').html(data_contentset_dropdown_tingkat);
}
...
var objextractJSONIsiTable=JSON.parse(dataextractJSONIsiTable);
var content_of_extractJSONIsiTable=objextractJSONIsiTable[targetextractJSONIsiTable];
...
$('#tabel_siswa').dataTable().fnClearTable();
if(data_content.length>0){
$('#tabel_siswa').dataTable().fnAddData(data_content);
}
