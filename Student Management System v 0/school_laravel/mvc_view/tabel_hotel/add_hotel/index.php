<?php
$page_name="Add Data Hotel SMP | Sistem Sekolahan";
$modul_id="tabel_hotel";
$modul_id_page_id="tabel_hotel_add_hotel";
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Add Data Hotel SMP
        <small>Form Add Data Hotel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Hotel</a></li>
        <li class="active">Add Data Hotel SMP</li>
      </ol>
    </section>
...
function upload_data_hotel(){
ajaxjson_upload_data_hotel = buatajax();
var url="http://localhost/hargakamar/API/";
ajaxjson_upload_data_hotel.onreadystatechange = stateChangedjson_upload_data_hotel;
ajaxjson_upload_data_hotel.open("POST",url,true);
ajaxjson_upload_data_hotel.setRequestHeader("Content-Type", "application/json");
var data = JSON.stringify({"modul":"report","action":"insert_data_hotel","nama":isian_nama,"pelajaran_favorit":isian_pelajaranfavorit,"email":isian_email,"tingkat_id":pilihan_tingkat_hotel,"kelas_id":pilihan_kelas_hotel,"alamat":isian_alamat,"handphone":isian_handphone,"fotoprofil":isian_fotoprofil_file_content,"sertifikat":isian_sertifikat});
console.log("Data sent from upload_data_hotel : "+data);
ajaxjson_upload_data_hotel.send(data);


}
var ajaxjson_upload_data_hotel;
function stateChangedjson_upload_data_hotel(){
  var this_html_response;
   if (ajaxjson_upload_data_hotel.readyState==4){
     this_html_response=ajaxjson_upload_data_hotel.responseText;
     console.log("response from upload_data_hotel : "+ajaxjson_upload_data_hotel.responseText);
     if(this_html_response.length>0){
     var hasilInsertDataHotel = ekstrakHasilUpdate(this_html_response,"response_data");
if (hasilInsertDataHotel == 1){
