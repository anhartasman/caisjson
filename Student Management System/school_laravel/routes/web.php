...
Route::get('/admin/tabel_siswa/add_siswa', ['uses'=>'model_controller_tabel_siswa@page_add_siswa']);
Route::get('/admin/tabel_siswa/edit_siswa/id/{id}', ['uses'=>'model_controller_tabel_siswa@page_edit_siswa']);
Route::get('/admin/tabel_siswa/delete_siswa/id/{id}', ['uses'=>'model_controller_tabel_siswa@page_delete_siswa']);
Route::get('/admin/tabel_siswa/daftar_siswa', ['uses'=>'model_controller_tabel_siswa@page_daftar_siswa']);
