...
var objekstrakHasilUpdate=JSON.parse(dataekstrakHasilUpdate);
var content_of_ekstrakHasilUpdate=objekstrakHasilUpdate[targetekstrakHasilUpdate];
...
window.location.href = 'http://localhost/school_laravel/admin/'+moduljumpketabel+'/'+pagejumpketabel;
