...
<div class="form-group">
  ...
  <img id="img_of_fotoprofil" src="http://localhost/school_laravel/public/uploads/<?php print($data_diri_siswa['fotoprofil']);?>" alt="no image" />  
</div>
...
window.location.href = 'http://localhost/school_laravel/admin/'+modulpindahHalaman+'/'+pagepindahHalaman;
