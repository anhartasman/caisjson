  ...
  <div class="col-xs-12 table-responsive">
    <table class="table table-striped">
      ...
      <tr>
       ...
       -->
      <tr><td>1</td><td>account</td><td>login</td><td>email(1),password(1),</td><td>http://localhost/school_laravel/API</td></tr><tr><td>2</td><td>report</td><td>get_students</td><td>kelas_id(1),tingkat_id(1),</td><td>http://localhost/school_laravel/API</td></tr><tr><td>3</td><td>report</td><td>get_tingkat</td><td></td><td>http://localhost/school_laravel/API</td></tr><tr><td>4</td><td>report</td><td>get_kelas</td><td>tingkat_id(1),</td><td>http://localhost/school_laravel/API</td></tr><tr><td>5</td><td>report</td><td>insert_data_siswa</td><td>kelas_id(1),tingkat_id(1),nama(1),email(1),alamat(1),sertifikat(1),handphone(1),fotoprofil(1),pelajaran_favorit(0),</td><td>http://localhost/school_laravel/API</td></tr><tr><td>6</td><td>report</td><td>update_data_siswa</td><td>siswa_id(1),kelas_id(1),tingkat_id(1),nama(1),email(1),alamat(1),sertifikat(1),handphone(1),pelajaran_favorit(1),fotoprofil(0),</td><td>http://localhost/school_laravel/API</td></tr><tr><td>7</td><td>report</td><td>delete_data_siswa</td><td>siswa_id(1),</td><td>http://localhost/school_laravel/API</td></tr>
      </tbody>
    </table>
  </div>
  <!-- /.col -->
