...
class model_controller_report extends Controller
{
  /**
  ...
  **/
    ...
    function page_get_students($obj){
...
function page_insert_data_siswa($obj){
$variables=getVariables();
extract($variables);
$prosesapi=1;
$error_code="000";
...
$data_file_param_api_fotoprofil_filename = str_replace(":","_",$data_file_param_api_fotoprofil_filename);
$data_file_param_api_fotoprofil_filename = str_replace("-","_",$data_file_param_api_fotoprofil_filename);
file_put_contents(public_path().$base_upload_directory.$data_file_param_api_fotoprofil_filename, $data_file_param_api_fotoprofil_content);
...
$hasil_insert_siswa_last_id = $obj_table_tb_siswa->getLastId();
...
function page_update_data_siswa($obj){
$variables=getVariables();
extract($variables);
$prosesapi=1;
$error_code="000";
...
if ( $data_file_param_api_fotoprofil_filename!=null){
if (file_exists(public_path().$base_upload_directory.$data_diri_siswa['fotoprofil'])) {
unlink(public_path().$base_upload_directory.$data_diri_siswa['fotoprofil']);
}
...
$hasil_updatefoto_siswa = $obj_table_tb_siswa->Go_table_for_modul_report_page_update_data_siswa_update_tb_siswa520($param_api_siswa_id,$data_file_param_api_fotoprofil_filename);
...
function page_delete_data_siswa($obj){
$variables=getVariables();
extract($variables);
$prosesapi=1;
$error_code="000";
